---
lab:
    title: '14 - Key Vault (Implementing Secure Data by setting up Always Encrypted)'
    module: 'Module 14 -Security for Applications'
---

# Lab 14: Key Vault (Implementing Secure Data by setting up Always Encrypted)
# Student lab manual
